<div class="about-header">
  <img src="assets/profile.jpg" alt="Vasileios profile" class="about-avatar" width="160" height="160" loading="lazy" />
  <div class="about-header-content">
    <h1 class="title"><span class="intro">Hi I'm</span> Vasileios Evangelopoulos!</h1>
    <div class="about-socials" style="display:flex;gap:1.25rem;align-items:center;flex-wrap:wrap;margin-top:0.5rem;">
  



  <a class="about-link"  href="https://github.com/euagelobill" target="_blank" rel="noopener" style="display:inline-flex;align-items:center;gap:0.5rem;text-decoration:none;color:var(--color-accent-2);">
  ...
  <a class="about-link" href="https://www.linkedin.com/in/vasileios-evangelopoulos/" target="_blank" rel="noopener" style="display:inline-flex;align-items:center;gap:0.5rem;text-decoration:none;color:var(--color-accent-2);">
  ...
  <a class="about-link" href="mailto:vasileiosevangelopoulos1@gmail.com" style="display:inline-flex;align-items:center;gap:0.5rem;text-decoration:none;color:var(--color-accent-2);">
